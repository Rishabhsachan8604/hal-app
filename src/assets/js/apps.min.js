...
var floatSubMenuTimeout, targetFloatMenu, handleSidebarMenu = function() {
        "use strict";
    ...
    handleMobileSidebarToggle = function() {
        ...
        $(".sidebar").bind("click touchstart", function(e) {
            0 !== $(e.target).closest(".sidebar").length ? i = !0 : (i = !1, e.stopPropagation())
        }), $(document).bind("click touchstart", function(e) {
            0 === $(e.target).closest(".sidebar").length && (i = !1), e.isPropagationStopped() || !0 === i || ($("#page-container").hasClass("page-sidebar-toggled") && (i = !0, $("#page-container").removeClass("page-sidebar-toggled")), $(window).width() <= 767 && $("#page-container").hasClass("page-right-sidebar-toggled") && (i = !0, $("#page-container").removeClass("page-right-sidebar-toggled")))
        }), $(document).on("click", '[data-click="right-sidebar-toggled"]', function(e) {
            e.stopPropagation();
            var t = "#page-container",
                a = "page-right-sidebar-toggled";
            $(t).hasClass(a) ? $(t).removeClass(a) : !0 !== i ? $(t).addClass(a) : i = !1
        }), $(document).on("click", '[data-click="sidebar-toggled"]', function(e) {
            e.stopPropagation();
            var t = "page-sidebar-toggled",
                a = "#page-container";
            $(a).hasClass(t) ? $(a).removeClass(t) : !0 !== i ? $(a).addClass(t) : i = !1, $(window).width() < 480 && $("#page-container").removeClass("page-right-sidebar-toggled")
        })
    },
    handleSidebarMinify = function() {
        ...
        $(document).on("click", '[data-click="sidebar-minify"]', function(e) {
            ...
            var t = "page-sidebar-minified",
                a = "#page-container";
            $('#sidebar [data-scrollbar="true"]').css("margin-top", "0"), $('#sidebar [data-scrollbar="true"]').removeAttr("data-init"), $("#sidebar [data-scrollbar=true]").stop(), $(a).hasClass(t) ? $(a).removeClass(t) : ($(a).addClass(t), /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && ($('#sidebar [data-scrollbar="true"]').css("margin-top", "0"), $('#sidebar [data-scrollbar="true"]').css("overflow-x", "scroll"))), $(window).trigger("resize")
        })
    },
    handleMobileSidebar = function() {
        ...
        $(".page-sidebar-minified .sidebar [data-scrollbar=true] a").bind("touchstart", function(e) {
            var t = (e.originalEvent.touches[0] || e.originalEvent.changedTouches[0]).pageY;
            r = t - parseInt($(this).closest("[data-scrollbar=true]").css("margin-top"))
        }), $(".page-sidebar-minified .sidebar [data-scrollbar=true] a").bind("touchmove", function(e) {
            if (e.preventDefault(), /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
                var t = (e.originalEvent.touches[0] || e.originalEvent.changedTouches[0]).pageY - r;
            ...
            var s = -parseInt(r) + $(".sidebar").height();
            if (o <= s && a <= o && n <= o) {
                var l = a - o - 20;
                $(t).animate({
                    marginTop: l + "px"
                })
            } else 0 <= parseInt(r) || o <= n ? $(t).animate({
                marginTop: "0px"
            }) : (l = r, $(t).animate({
                marginTop: l + "px"
            }));
    ...
    handleSidebarScrollMemory = function() {
        if (!/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
            $('.sidebar [data-scrollbar="true"]').slimScroll().bind("slimscrolling", function(e, t) {
                localStorage.setItem("sidebarScrollPosition", t + "px")
            });
    ...
    handleSidebarMinifyFloatMenu = function() {
        $(document).on("click", "#float-sub-menu li.has-sub > a", function(e) {
            var t = $(this).next(".sub-menu"),
                ...
                r = !1,
                d = !1;
            $(t).is(":visible") ? ($(a).addClass("closing"), r = !0) : ($(a).addClass("expanding"), d = !0), $(t).slideToggle({
                duration: 250,
                progress: function() {
                    var e = $("#float-sub-menu"),
                        t = $(e).height(),
                        a = $(e).offset(),
                        i = $(e).attr("data-offset-top"),
                        n = $(e).attr("data-menu-offset-top"),
                        o = a.top - $(window).scrollTop(),
                        s = $(window).height();
                    if (r && i < o && (o = i < o ? i : o, $("#float-sub-menu").css({
                            top: o + "px",
                            bottom: "auto"
                ...
                complete: function() {
                    $(t).is(":visible") ? $(a).addClass("expand") : $(a).addClass("closed"), $(a).removeClass("closing expanding")
                }
            })
            ...
            if ($("#page-container").hasClass("page-sidebar-minified")) {
                ...
                var t = $(e).html();
                if (t) {
                    var a = $("#sidebar").offset(),
                        i = $("#page-container").hasClass("page-with-right-sidebar") ? $(window).width() - a.left : a.left + 70,
                        n = $(e).height(),
                        o = $(this).offset().top - $(window).scrollTop(),
                        s = $("#page-container").hasClass("page-with-right-sidebar") ? "auto" : i,
                        l = $("#page-container").hasClass("page-with-right-sidebar") ? i : "auto",
                        r = $(window).height();
    ...
    handleUnlimitedTopMenuRender = function() {
        ...
        function t(e, t) {
            ...
            switch ($(a).find("li").each(function() {
                ...
                case "prev":
                    var l;
                    (l = -i) <= n ? ($(a).find(".menu-control.menu-control-left").removeClass("show"), s = 0) : s = l - n + 88, $(a).animate({
                        marginLeft: "-" + s + "px"
                    }, 150, function() {
        ...
        function e() {
            ...
            o != s && n <= s ? $(e).find(".menu-control.menu-control-right").addClass("show") : $(e).find(".menu-control.menu-control-right").removeClass("show"), n <= o && n <= s ? $(e).find(".menu-control.menu-control-left").addClass("show") : $(e).find(".menu-control.menu-control-left").removeClass("show")
        }
    ...
    handlePageLoad = function() {
        "use strict";
        $("#page-loader").addClass("hide"), handleCheckBootstrapVersion() < 4 ? $("#page-container").addClass("in") : $("#page-container").addClass("show")
    },
    ...
    handlePanelAction = function() {
        ...
        panelActionRunning = !0, $('[data-click="panel-remove"]').hover(function() {
            $(this).tooltip({
                title: "Remove",
                placement: "bottom",
                trigger: "hover",
            ...
            4 <= t && t < 5 ? $(this).tooltip("dispose") : $(this).tooltip("destroy"), $(this).closest(".panel").remove()
            ...
            if (!$(t).hasClass("panel-loading")) {
                ...
                $(t).addClass("panel-loading"), $(a).prepend('<div class="panel-loader"><span class="spinner-small">Loading...</span></div>'), setTimeout(function() {
            ...
            var t = $(this).closest(".panel"),
                a = "panel-expand",
                i = $(t).find(".panel-body"),
                n = $(t).hasClass(a) ? $(this).attr("data-collapse-callback") : $(this).attr("data-expand-callback");
    ...
    handleHeaderScroll = function() {
        $(window).on("scroll", function() {
            0 < $(window).scrollTop() ? $("#header").addClass("has-scroll") : $("#header").removeClass("has-scroll")
        })
    },
    ...
    App = function() {
        ...
        return {
            initSidebar: function() {
                handleSidebarMenu(), handleMobileSidebarToggle(), handleSidebarMinify(), handleSidebarMinifyFloatMenu(), handleMobileSidebar(), (!t || t && !t.disableSidebarScrollMemory) && handleSidebarScrollMemory()
            },
            ...
            init: function(e) {
                e && (t = e), this.initHeader(), this.initTopMenu(), this.initSidebar(), this.initComponent(), this.initPageLoad()
            },
            scrollTop: function() {
                $("html, body").animate({
                    scrollTop: $("body").offset().top
